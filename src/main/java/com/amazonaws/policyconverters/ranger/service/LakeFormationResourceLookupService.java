...
public class LakeFormationResourceLookupService extends RangerBaseService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LakeFormationResourceLookupService.class);
    ...
    public LakeFormationResourceLookupService() {
    ...
    LakeFormationResourceLookupService(GlueClientFactory glueClientFactory) {
