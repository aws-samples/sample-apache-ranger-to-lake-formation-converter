package com.amazonaws.policyconverters.ranger.mapper;
...
public class PrincipalMapper {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PrincipalMapper.class);
    ...
    private PrincipalMapper(Map<String, String> userMappings,
    ...
    /**
     * Create a PrincipalMapper from a {@link PrincipalMappingConfig}.
     */
    ...
    /**
     * Create a PrincipalMapper by loading mappings from a JSON or properties file.
     * <p>
     ...
     * @return a PrincipalMapper loaded from the file
     * @throws IOException if the file cannot be read or parsed
     */
    public static PrincipalMapper fromFile(String filePath) throws IOException {
    ...
    private static PrincipalMapper loadFromJson(File file) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        PrincipalMappingConfig config = objectMapper.readValue(file, PrincipalMappingConfig.class);
        return fromConfig(config);
    }

    private static PrincipalMapper loadFromProperties(File file) throws IOException {
        ...
        return new PrincipalMapper(userMappings, groupMappings, roleMappings);
    }
}
