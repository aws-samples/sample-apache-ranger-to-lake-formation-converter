...
/**
 * Unit tests for LakeFormationPlugin.
 * Validates: Requirements 4.1
 */
class LakeFormationPluginTest {
    ...
    void serviceTypeConstantMatchesExpectedValue() {
        assertEquals("lakeformation", LakeFormationPlugin.SERVICE_TYPE);
    }

    @Test
    void appIdConstantMatchesExpectedValue() {
        assertEquals("lakeformation", LakeFormationPlugin.APP_ID);
    }
