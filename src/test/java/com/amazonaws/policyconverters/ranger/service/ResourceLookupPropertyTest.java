...
class ResourceLookupPropertyTest {
    ...
    void resourceLookupReturnsMatchingDatabases(
        ...
        ResourceLookupService service = createService(mockGlue);
    ...
    private ResourceLookupService createService(GlueClient mockGlue) {
